...
"")
        ...
        self.gridLayout_4.addWidget(self.frame_8, 3, 7, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.select_pagamento_venda, 2, 0, 1, 2)

        self.label_6 = QLabel(self.frame_7)
        self.label_6.setObjectName(u"label_6")

        self.gridLayout_4.addWidget(self.label_6, 0, 7, 1, 1)

        self.lb_vendas_medida = QLabel(self.frame_7)
        self.lb_vendas_medida.setObjectName(u"lb_vendas_medida")

        self.gridLayout_4.addWidget(self.lb_vendas_medida, 1, 7, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.tb_vendas_itens, 3, 0, 1, 7)
        ...
        self.gridLayout_4.addWidget(self.txt_venda_vencimento, 2, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lb_vencimento_venda, 2, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.btn_venda_addProduto, 2, 6, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.txt_venda_quantidade, 1, 6, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lb_venda_total, 4, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.select_status_venda, 2, 4, 1, 2)
        ...
        sizePolicy3.setHeightForWidth(self.frame_graph_cliente.sizePolicy().hasHeightForWidth())
        self.frame_graph_cliente.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.frame_graph_fornecedor_detail.sizePolicy().hasHeightForWidth())
        self.frame_graph_fornecedor_detail.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.frame_graph_produto.sizePolicy().hasHeightForWidth())
        self.frame_graph_produto.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.btn_cadastrar_produto.sizePolicy().hasHeightForWidth())
        self.btn_cadastrar_produto.setSizePolicy(sizePolicy5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.select_produto_venda.setItemText(0, QCoreApplication.translate("MainWindow", u"Selecione o Produto", None))
